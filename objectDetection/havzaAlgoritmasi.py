#görüntünün farkli nesnelerini ayirmak için kullailan klasik bir algoritmadir
...
plt.figure(),plt.imshow(coin_gray,cmap="gray"),plt.axiss("off")
...
#kontur
#contours,hierarchy=cv2.findContours(coin_thresh.copy()) ->bazen bu şekil çalişiyor
